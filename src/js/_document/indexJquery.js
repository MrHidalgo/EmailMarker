  ...
  * ============================================= */
  ...
  const initSVGAnimation = () => {
    ...
    const initVerificationAnimation = () => {
      ...
      _tlVerification
        .fromTo('.verification-flower', 0.75, {opacity: 0}, {opacity: 1, ease: Power1.easeInOut})
        .fromTo('.verification-cloud', 1, {opacity: 0, x:'-150px'}, {opacity: 1, x:0, ease: Power1.easeInOut}, '-=0.75')
        .fromTo('.verification-point', 0.75, {opacity: 0}, {opacity: 1, ease: Power1.easeInOut}, '-=1')
        .fromTo('#verification-graph-line', 1, {opacity: 0}, {opacity: 1, ease: Power1.easeInOut}, '-=0.7')
        .fromTo('#verification-rect-main, #verification-rect-gr', 0.75, {opacity: 0}, {opacity: 1, ease: Power1.easeInOut}, '-=0.3')
        .fromTo('#verification-graph-circle', 1.5, {opacity: 0, scale: 0, rotation:360, transformOrigin: 'center'}, {opacity: 1, scale:1, rotation: 0, ease: Power1.easeInOut}, '-=0.75')
        .fromTo('#verification-data', 0.75, {opacity: 0, x:'100px'}, {opacity: 1, x:0, ease: Power1.easeInOut}, '-=1')
        .fromTo('.verification-download-list-0', 1, {opacity: 0, x:'100px'}, {opacity: 1, x:0, ease: Power1.easeInOut}, '-=1')
        .fromTo('.verification-download-list-1', 1, {opacity: 0, x:'150px'}, {opacity: 1, x:0, ease: Power1.easeInOut}, '-=0.75')
        .fromTo('#verification-man', 1, {opacity: 0, x:'-200px'}, {opacity: 1, x:0, ease: Power1.easeInOut}, '-=1')
        .fromTo('#verification-man-card', 0.75, {opacity: 0, y:'-100px'}, {opacity: 1, y:0, ease: Power1.easeInOut}, '-=1')
      ;
    ...
    const initValidateAnimation1 = () => {
      ...
      _tlValidateDesc
        ...
        .fromTo('.validate-1-flower-2', 0.75, {opacity: 0}, {opacity:1, ease: Power1.easeInOut}, '-=0.1')
        .fromTo('.validate-1-flower-3', 0.45, {opacity: 0}, {opacity:1, ease: Power1.easeInOut}, '-=0.3')
        .fromTo('.validate-1-flower-4', 0.75, {opacity: 0}, {opacity:1, ease: Power1.easeInOut}, '-=0.25')
        .fromTo('.validate-1-circle', 1, {opacity: 0}, {opacity:1, ease: Power1.easeInOut}, '-=1')
        .fromTo('.validate-1-table-1', 0.35, {opacity: 0, height:0}, {opacity:1, height:'auto', ease: Power1.easeInOut}, '-=0.3')
        .fromTo('.validate-1-table-2', 0.35, {opacity: 0, height:0}, {opacity:1, height:'auto', ease: Power1.easeInOut}, '-=0.3')
        .fromTo('.validate-1-table-3', 0.35, {opacity: 0, height:0}, {opacity:1, height:'auto', ease: Power1.easeInOut}, '-=0.3')
        .fromTo('.validate-1-table-4', 0.35, {opacity: 0, height:0}, {opacity:1, height:'auto', ease: Power1.easeInOut}, '-=0.3')
        ...
        .fromTo('#validate-1-woman', 1, {opacity: 0, x:'150px'}, {opacity:1, x:0, ease: Power1.easeInOut}, '-=0.75');
